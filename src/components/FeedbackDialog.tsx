    ...
    <Show when={props.isOpen}>
      ...
      >
        ...
        >
          ...
          <Show when={submitSuccess()} fallback={
            <form onSubmit={handleSubmit} class="flex flex-col gap-4">
              ...
              <div class="flex flex-col gap-1.5">
                <label class="text-xs font-semibold text-text-secondary">{t("feedback.messageLabel")}</label>
                <textarea
                  value={message()}
              ...
              <div class="flex flex-col gap-1.5">
                <label class="text-xs font-semibold text-text-secondary">{t("feedback.emailLabel")}</label>
                <input
                  type="email"
                  value={email()}
              ...
              <div class="flex items-center gap-2 py-1">
                <input
                  ...
                  class="accent-accent"
                />
                <label for="attach-diag" class="text-xs text-text-secondary cursor-pointer select-none">
