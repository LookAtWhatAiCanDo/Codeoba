...
export const Dashboard = (props: DashboardProps) => {
  ...
  return (
    <div class="flex-grow h-full flex flex-col bg-background/95 min-w-0 relative overflow-hidden transition-all duration-200 focus-within:z-[51] group">
      {/* Focus Highlight Border Overlay. Lives on this non-scrolling wrapper so it
          stays locked to the pane frame instead of stretching to scrollHeight. */}
