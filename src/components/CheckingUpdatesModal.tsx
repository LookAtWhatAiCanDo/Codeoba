...
export const CheckingUpdatesModal = (props: CheckingUpdatesModalProps) => {
  ...
  return (
    <BaseModal
      ...
      backdropClass="fixed inset-0 bg-black/75 z-[1100] flex items-center justify-center animate-in fade-in duration-200 backdrop-blur-md"
      class="w-[420px] bg-surface border border-border/80 p-6 rounded-2xl flex flex-col items-center gap-5 shadow-2xl relative animate-in zoom-in-95 duration-200 text-center"
    >
      {/* Close button */}
      <button
